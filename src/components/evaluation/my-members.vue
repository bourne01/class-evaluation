    ...
    <div class="members" 
        ...
        <div class="numone">
            <div class="circle-box">
                <img 
                    :src="require('../../assets/svg/circle.svg')" alt=""
                    v-if="clickIdx!=index"
                    >
                <img :src="require('../../assets/svg/circle-selected-purpse.svg')" alt="" v-else>
            </div>
            <div class="head-box">
                <img :src="require('../../assets/home/4.png')" alt="">
            </div>
            <div class="introduce">
                <h4>周庶</h4><span>
                    <img :src="require('../../assets/home/male.png')" alt="">
                </span>
                <p>ID 124633</p>
            </div>
        </div>
